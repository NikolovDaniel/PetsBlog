...
namespace PetBlog.Infrastructure.Data.Repositories
{
    /// <summary>
    ...
    public class Repository : IRepository
    {
        ...
        /// <summary>
        /// Gets all Pets with Title Image.
        /// </summary>
        /// <returns></returns>
        public IEnumerable<Pet> GetAllPetsWithTitleImage()
        {
            var petsWithImage = this.DbSet<Pet>()
                .AsNoTracking()
                .Include(p => p.Images.Where(i => ((Images)i).Category == "Title"))
                .ToList();
                
            return petsWithImage;
        }
        ...
        /// <returns>Count of all Entities as int.</returns>
        public async Task<int> Count<T>() where T : class
        {
            int count = await this.DbSet<T>().CountAsync();
